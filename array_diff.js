...
// 1. I'm not super confident on how to approach this, but I think .filter() would work well here. Just not sure if it can take an array as a parameter (and it can, just need to use .includes as well)
